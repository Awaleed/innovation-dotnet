...
public class ChallengeConfiguration : IEntityTypeConfiguration<Challenge>
{
    public void Configure(EntityTypeBuilder<Challenge> builder)
    {
        ...
        builder
            .HasOne(e => e.SustainabilityImpact)
            .WithOne(s => s.Challenge)
            .HasForeignKey<ChallengeSustainabilityImpact>(s => s.ChallengeId)
            .OnDelete(DeleteBehavior.Cascade);
        builder
            .HasOne(e => e.IntellectualProperty)
            .WithOne(ip => ip.Challenge)
            .HasForeignKey<ChallengeIntellectualProperty>(ip => ip.ChallengeId)
            .OnDelete(DeleteBehavior.Cascade);

        builder
            .HasMany(e => e.ChallengeUsers)
            .WithOne(cu => cu.Challenge)
