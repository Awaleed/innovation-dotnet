    ...
    return (
        <>
            <input
                ...
                className={`h-11 w-full rounded-md border bg-white px-3 text-sm text-[#111827] outline-none transition-colors placeholder:text-[#9ca3af] focus:border-[#8b84d7] focus:ring-2 focus:ring-[#8b84d7]/20 ${hasError ? "border-[#ef4444]" : "border-[#e5e7eb]"} ${attribute.readOnly ? "bg-gray-50 text-gray-500" : ""}`}
                aria-invalid={
