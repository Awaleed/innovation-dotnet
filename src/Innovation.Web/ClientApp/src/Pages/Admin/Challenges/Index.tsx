...
export default function ChallengesIndex({ challenges }: Props) {
    ...
    const [viewMode, _setViewMode] = useQueryState('viewMode', parseAsStringLiteral(['list', 'grid'] as const).withDefault('list'));
    ...
    const columns: ColumnDef<IChallengeListResponse>[] = useMemo(
        () => [
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="flex flex-col gap-1">
                            <div className="font-sans font-medium text-primary">{challenge.title}</div>
                            <div className="font-sans text-sm text-primary/70">{challenge.organizer}</div>
                        </div>
                    );
                },
            },
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    const maxParticipants = row.original.maxParticipants;
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    return featured ? <Trophy className="h-4 w-4 text-accent" /> : '-';
                },
            },
            {
                id: 'actions',
    ...
    const renderGridItem = (challenge: IChallengeListResponse) => (
        <Card
            className="h-full border bg-muted/50 border-border/50"
        >
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            ...
                            {challenge.featured && (
                                <Badge
                                    variant="secondary"
                                    className="border-0 bg-muted text-accent"
                                >
            ...
            <div className="container mx-auto space-y-6 p-8">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    <Card className="border">
                        ...
                        <CardContent>
                            <div className="font-heading text-2xl font-bold text-primary">{challenges?.totalCount ?? 0}</div>
                        </CardContent>
                    </Card>
                    <Card className="border">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
