 ...
 */
export default function Logo({ variant = 'bilingual', size = 'medium', theme: themeMode, noPadding = false, className, ...props }: LogoProps) {
        ...
        >
            <img
                ...
                onError={(e) => {
                    ...
                    console.warn(`Logo not found: ${logoPath}. Theme: ${themeConfig.name}, Variant: ${variant}, Mode: ${finalThemeMode}`);
                    ...
                    placeholder.className = 'flex items-center justify-center bg-gray-100 text-gray-400 text-xs rounded';
