...
const classForSeparator = cva(
  ...
  ],
  {
    variants: {
      ...
      labelOrientation: {
        vertical:
          "absolute inset-x-[calc(50%+30px)] top-5 block shrink-0 ltr:left-[calc(50%+30px)] ltr:right-[calc(-50%+20px)] rtl:right-[calc(50%+30px)] rtl:left-[calc(-50%+20px)]",
        horizontal: "",
      },
    },
  }
...
const onStepKeyDown = (
  ...
  const directions = {
    next: isRtl ? ["ArrowLeft", "ArrowDown"] : ["ArrowRight", "ArrowDown"],
    prev: isRtl ? ["ArrowRight", "ArrowUp"] : ["ArrowLeft", "ArrowUp"],
  };
