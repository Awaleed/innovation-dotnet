...
export function getChallengeStatusVariant(
...
export function getChallengeDifficultyBadgeClasses(
...
export function getChallengeParticipationTypeColor(
  participationType?: ChallengeParticipationType | null,
): string {
...
export function getChallengeSubmissionTypeColor(
  submissionType?: ChallengeSubmissionType | null,
): string {
...
export function getChallengeSubmissionTypeIcon(
  submissionType?: ChallengeSubmissionType | null,
): string {
...
export function getWinnerSelectionMethodVariant(
  method?: WinnerSelectionMethod | null,
): 'default' | 'secondary' | 'destructive' | 'outline' {
